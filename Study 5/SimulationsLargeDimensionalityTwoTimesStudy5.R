...
output_dir = "Study 5/Intermediate_results_study5"
...
run_scenario = function(n, scenario) {
  ...
  for(i in 1:nrep){
    ...
    file.name = file.path(output_dir, paste("LargeDimensionality_TwoTimeStudy5_V2_scenario_", scenario, "_", n, ".Rdata", sep=""))
