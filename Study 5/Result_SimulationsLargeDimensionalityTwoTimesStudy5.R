...
setwd("Study 5/Intermediate_results_study5")
...
cat("===== Table 6 of supplementary material, Simple scenario, n = 300 =====\n")
print(res300$simple) #(Table 6)

cat("===== Table 7 of supplementary material, Medium scenario, n = 300 =====\n")
print(res300$medium) #(Table 7)

cat("===== Table 8 of supplementary material, Complex scenario, n = 300 =====\n")
print(res300$complex) #(Table 8)
...
cat("===== Table 9 of supplementary material, Simple scenario, n = 1000 =====\n")
print(res1000$simple) #(Table 9)  

cat("===== Table 10 of supplementary material,  Medium scenario, n = 1000 =====\n")
print(res1000$medium) #(Table 10)

cat("===== Table 11 of supplementary material, Complex scenario, n = 1000 =====\n")
print(res1000$complex )#(Table 11)
...
cat("===== Table 12 of supplementary material- Study 5 =====\n")
print(
