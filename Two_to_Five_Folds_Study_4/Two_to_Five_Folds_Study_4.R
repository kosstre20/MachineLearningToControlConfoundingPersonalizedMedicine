...
output_dir = "Two_to_Five_Folds_Study_4/Intermediate_results_Two_to_Five_Folds_Study_4"
...
run_scenario = function(n, scenario, k_folds) {
  ...
  for(i in 1:nrep){
    ...
    file.name = file.path(output_dir,  paste("TwoTimeStudy4_V2_scenario_", scenario, "_", n,"_", k_folds, "folds.Rdata", sep=""))
