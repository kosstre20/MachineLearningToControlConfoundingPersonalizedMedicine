...
output_dir = "Study 2/Intermediate_results_study2"
...
#For each scenario, the true values must be executed for the computation of performance metrics.
...
#Medium
 ...
 #true.psi = c(lm(Y_1 - Y_0 ~ X1)$coef, psi2)
 # true.psi = c(1.500146, 3.002304, -0.500000, 1.000000)
#Complex
 ...
 # true.psi = c(lm(Y_1 - Y_0 ~ X1)$coef, psi2)
# true.psi = c(0.50965347, 0.02020462, -0.500000, 1.000000)
...
run_scenario = function(n, scenario) {
  ...
  for(i in 1:nrep){
    ...
    file.name = file.path(output_dir, paste("TwoTimeStudy2_V2_scenario_", scenario, "_", n, ".Rdata", sep=""))
