...
setwd("Study 3/Intermediate_results_study3")
...
true.psi.list = list(
  ...
  medium  = c(1.500146, 3.002304, -0.5, 1.0),
  complex = c(0.50965347, 0.02020462, -0.5, 1.0)
)
...
for (n in sizes) {
  res = run_simulation_analysis_all(
    ...
    data_prefix = "TwoTimeStudy3_V2_scenario_",     # Prefix for .Rdata 
    rql_prefix  = "RQL_TwoTimeStudy3_scenario_",     # Prefix for RQL-specific 
...
# Extract and format all evaluation metrics for n = 300 (Table 3 of main manuscript)
res300 = extract_all_metrics_for_n(all_results_by_n, 300, methods = simulation_methods, colnames.psi = colnames.psi)
cat("===== Table 3 of main manuscript, n = 300 =====\n")
print(res300) 

# Extract and format all evaluation metrics for n = 1000 (Table 3 of supplementary material)
res1000 = extract_all_metrics_for_n(all_results_by_n, 1000, methods = simulation_methods, colnames.psi = colnames.psi)
cat("===== Table 3 of supplementary material, n = 1000 =====\n")
print(res1000)  
...
cat("===== Table 5 of supplementary material- Study 3 =====\n")
